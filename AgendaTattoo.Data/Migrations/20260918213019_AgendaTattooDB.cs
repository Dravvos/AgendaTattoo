...
{
    /// <inheritdoc />
    public partial class AgendaTattooDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_Users_ArtistId",
                        column: x => x.ArtistId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_StudioId_ArtistId_StartsAt",
                table: "Appointments",
                columns: new[] { "StudioId", "ArtistId", "StartsAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Clients_StudioId_PhoneNumber",
                table: "Clients",
                columns: new[] { "StudioId", "PhoneNumber" });
